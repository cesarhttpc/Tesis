...
Monte_carlo_aprox_compilador = {}
Monte_carlo_compilador = {}
# Tiempo_compilador = {}
...
for k in range(len(num_vecinos_varios)):
    ...
    for j in range(len(num_puntos_malla)):
        ...
        Monte_carlo_compilador[contador] = monte_carlo
        ...
        Monte_carlo_aprox_compilador[contador] = monte_carlo_aprox
    ...
    fig, axs = plt.subplots(1,len(num_vecinos_varios) + 1,figsize = (8,5))
    fig.suptitle('Evolución de la posterior para %r ' %num_vecinos_varios[k])
    axs[0].hist(Monte_carlo_aprox_compilador[4*k+1], density = True)
    axs[0].hist(Monte_carlo_compilador[4*k+1], density = True)
    axs[1].hist(Monte_carlo_aprox_compilador[4*k+2], density = True)
    axs[1].hist(Monte_carlo_compilador[4*k+2], density = True)
    axs[2].hist(Monte_carlo_aprox_compilador[4*k+3], density = True)
    axs[2].hist(Monte_carlo_compilador[4*k+3], density = True)
    axs[3].hist(Monte_carlo_aprox_compilador[4*k+4], density = True)
    axs[3].hist(Monte_carlo_compilador[4*k+4], density = True)
    # axs[0].label_outer()
    axs[1].label_outer()
    axs[2].label_outer()
    axs[3].label_outer()
